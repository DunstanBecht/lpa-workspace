...
\null
\vfill
\includegraphics[width=\linewidth]{../data/fits_5e#1m-2/#3/output_plot.pdf}
\captionof{figure}{Distribution map and analysis}
\begin{center}
\includegraphics[width=0.7\linewidth]{../data/maps_5e#1m-2/#2}
\captionof{figure}{Distribution map and analysis}
\end{center}
\includegraphics[width=\linewidth]{../data/stats_5e#1m-2/#5}
\includegraphics[width=\linewidth]{../data/stats_5e#1m-2/#6}
\captionof{figure}{Distribution map and analysis}
}
