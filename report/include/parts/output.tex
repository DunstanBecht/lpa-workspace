...
\bigfig{fig:fit:example:rdd}{insert/fits/output\_data\_analysis/fits\_plot\_GUW1}{j1\_068nm}{Fit of \gls{guw1} over the harmonic 1 of the computed Fourier Transform of \gls{rdd}}
...
\txtlst{insert/fits}{fits\_data\_GUW2.dat}
