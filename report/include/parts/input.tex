...
\smallfig{fig:rdd-g-nec}{insert/expressions/plots}{square_RDD_g_NEC}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rdd-g-woa}{insert/expressions/plots}{square_RDD_g_WOA}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rdd-g-gbb}{insert/expressions/plots}{square_RDD_g_GBB}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rdd-Ga-nec}{insert/expressions/plots}{square_RDD_Ga_NEC}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rdd-Ga-woa}{insert/expressions/plots}{square_RDD_Ga_WOA}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rdd-Ga-gbb}{insert/expressions/plots}{square_RDD_Ga_GBB}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%

\newpage

From equations \eqref{eq:rdd-Ga-woa} and \eqref{eq:total-energy-woa} the total energy per unit volume for the edge consideration \gls{woa} can be expressed in equation \eqref{eq:rdd-energy-woa}.
As shown in \figref{fig:rdd-energy-woa} to \figref{fig:rdd-energy-nec-square} the latter is divergent.

\begin{align}
  \gls{totnrg}^{\gls{woa}} &=
    \frac{\gls{shrmod} | \gls{vecb} |^2}{4 \pi \left(1 - \gls{indfun}_{\mathrm{edge}} \gls{pssrat} \right)} \left( \ln \left( \frac{R_{\gls{roi}}}{r_0 \sqrt{e}} \right) + \left( \frac{r_0}{R_{\gls{roi}}} \right)^2 \ln \left( \frac{R_{\gls{roi}} \sqrt{e}}{r_0} \right) \right)
  \\
  \gls{totnrg}^{\gls{woa}} &\sim
    \frac{\gls{shrmod} | \gls{vecb} |^2}{4 \pi \left(1 - \gls{indfun}_{\mathrm{edge}} \gls{pssrat} \right)} \ln \left( \frac{\gls{cutrad}}{r_0} \right) \ \ \text{with} \ \ \gls{cutrad} = \frac{R_{\gls{roi}}}{\sqrt{e}}
    \label{eq:rdd-energy-woa}
\end{align}

\smallfig{fig:rdd-energy-woa}{insert/expressions/plots}{circle_RDD_energy_WOA}{\( e_T^{\gls{woa}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rdd-energy-nec-circle}{insert/expressions/plots}{circle_RDD_energy_NEC}{\( e_T^{\gls{nec}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rdd-energy-nec-square}{insert/expressions/plots}{square_RDD_energy_NEC}{\( e_T^{\gls{nec}} \left( S_{\gls{roi}} \right) \)}%
...
\smallfig{fig:rrdde-g-nec}{insert/expressions/plots}{square_RRDD-E_g_NEC}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrdde-g-woa}{insert/expressions/plots}{square_RRDD-E_g_WOA}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrdde-g-gbb}{insert/expressions/plots}{square_RRDD-E_g_GBB}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrdde-Ga-nec}{insert/expressions/plots}{square_RRDD-E_Ga_NEC}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrdde-Ga-woa}{insert/expressions/plots}{square_RRDD-E_Ga_WOA}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrdde-Ga-gbb}{insert/expressions/plots}{square_RRDD-E_Ga_GBB}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%

\bigskip

\figref{fig:rrdde-energy-woa} to \figref{fig:rrdde-energy3D-nec} show the behavior of the total energy stored per unit volume. It seems to depend little on \gls{cutrad} but more on \( s \).

\smallfig{fig:rrdde-energy-woa}{insert/expressions/plots}{circle_RRDD-E_energy_WOA}{\( e_T^{\gls{woa}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rrdde-energy-nec-circle}{insert/expressions/plots}{circle_RRDD-E_energy_NEC}{\( e_T^{\gls{nec}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rrdde-energy-nec-square}{insert/expressions/plots}{square_RRDD-E_energy_NEC}{\( e_T^{\gls{nec}} \left( S_{\gls{roi}} \right) \)}%

\medfig{fig:rrdde-energy3D-woa}{insert/expressions/plots}{circle_RRDD-E_energy3D_WOA}{\( e_T^{\gls{woa}} \left( s, R_{\gls{roi}} \right) \)}%
\medfig{fig:rrdde-energy3D-nec}{insert/expressions/plots}{circle_RRDD-E_energy3D_NEC}{\( e_T^{\gls{nec}} \left( s, R_{\gls{roi}} \right) \)}%
...
\smallfig{fig:rrddr-g-nec}{insert/expressions/plots}{square_RRDD-R_g_NEC}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrddr-g-woa}{insert/expressions/plots}{square_RRDD-R_g_WOA}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrddr-g-gbb}{insert/expressions/plots}{square_RRDD-R_g_GBB}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrddr-Ga-nec}{insert/expressions/plots}{square_RRDD-R_Ga_NEC}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrddr-Ga-woa}{insert/expressions/plots}{square_RRDD-R_Ga_WOA}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrddr-Ga-gbb}{insert/expressions/plots}{square_RRDD-R_Ga_GBB}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%

\bigskip

\figref{fig:rrddr-energy-woa}, to \figref{fig:rrddr-energy3D-nec} show the behavior of the total energy stored per unit volume. It does not diverge.

\smallfig{fig:rrddr-energy-woa}{insert/expressions/plots}{circle_RRDD-R_energy_WOA}{\( e_T^{\gls{woa}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rrddr-energy-nec-circle}{insert/expressions/plots}{circle_RRDD-R_energy_NEC}{\( e_T^{\gls{nec}} \left( R_{\gls{roi}} \right) \)}%
\smallfig{fig:rrddr-energy-nec-square}{insert/expressions/plots}{square_RRDD-R_energy_NEC}{\( e_T^{\gls{nec}} \left( S_{\gls{roi}} \right) \)}%

\medfig{fig:rrddr-energy3D-woa}{insert/expressions/plots}{circle_RRDD-R_energy3D_WOA}{\( e_T^{\gls{woa}} \left( s, R_{\gls{roi}} \right) \)}%
\medfig{fig:rrddr-energy3D-nec}{insert/expressions/plots}{circle_RRDD-R_energy3D_NEC}{\( e_T^{\gls{nec}} \left( s, R_{\gls{roi}} \right) \)}%
