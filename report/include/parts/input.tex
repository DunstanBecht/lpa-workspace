...
\medfig{fig:rrdde-cutrad3D-woa}{insert/expressions/plots}{circle_RRDD-E_cutrad3D_WOA}{\( \gls{cutrad}^{\gls{woa}} \) as a function of \( s \) and \( R_{\gls{roi}} \)}%
\medfig{fig:rrdde-cutrad3D-nec}{insert/expressions/plots}{circle_RRDD-E_cutrad3D_NEC}{\( \gls{cutrad}^{\gls{nec}} \) as a function of \( s \) and \( R_{\gls{roi}} \)}%
...
\medfig{fig:rrddr-cutrad3D-woa}{insert/expressions/plots}{circle_RRDD-R_cutrad3D_WOA}{\( \gls{cutrad}^{\gls{woa}} \) as a function of \( s \) and \( R_{\gls{roi}} \)}%
\medfig{fig:rrddr-cutrad3D-nec}{insert/expressions/plots}{circle_RRDD-R_cutrad3D_NEC}{\( \gls{cutrad}^{\gls{nec}} \) as a function of \( s \) and \( R_{\gls{roi}} \)}%
