...
\bigfig{fig:KKKK-example}{insert/analysis}{example_KKKK_GBB}{Statistical spatial analysis of a sample of \gls{rdd} with the function \gls{funK}}%
...
\bigfig{fig:gggg-example}{insert/analysis}{example_gggg_GBB}{Statistical spatial analysis of a sample of \gls{rdd} with the function \gls{fung}}%
...
\bigfig{fig:GaGs-example}{insert/analysis}{example_GaGs_GBB}{Statistical spatial analysis of a sample of \gls{rdd} with the functions \gls{funGa} and \gls{funGs}}%
...
\smallfig{fig:rdd-g-nec}{insert/expressions/plots}{g++_g+-_NEC_RDD_square}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rdd-g-woa}{insert/expressions/plots}{g++_g+-_WOA_RDD_square}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rdd-g-gbb}{insert/expressions/plots}{g++_g+-_GBB_RDD_square}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rdd-Ga-nec}{insert/expressions/plots}{GA_GS_NEC_RDD_square}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rdd-Ga-woa}{insert/expressions/plots}{GA_GS_WOA_RDD_square}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rdd-Ga-gbb}{insert/expressions/plots}{GA_GS_GBB_RDD_square}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrdde-g-nec}{insert/expressions/plots}{g++_g+-_NEC_RRDD-E_square}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrdde-g-woa}{insert/expressions/plots}{g++_g+-_WOA_RRDD-E_square}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrdde-g-gbb}{insert/expressions/plots}{g++_g+-_GBB_RRDD-E_square}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrdde-Ga-nec}{insert/expressions/plots}{GA_GS_NEC_RRDD-E_square}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrdde-Ga-woa}{insert/expressions/plots}{GA_GS_WOA_RRDD-E_square}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrdde-Ga-gbb}{insert/expressions/plots}{GA_GS_GBB_RRDD-E_square}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrddr-g-nec}{insert/expressions/plots}{g++_g+-_NEC_RRDD-R_square}{\( \gls{fung}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrddr-g-woa}{insert/expressions/plots}{g++_g+-_WOA_RRDD-R_square}{\( \gls{fung}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrddr-g-gbb}{insert/expressions/plots}{g++_g+-_GBB_RRDD-R_square}{\( \gls{fung}^{\gls{gbb}}(r) \)}%
...
\smallfig{fig:rrddr-Ga-nec}{insert/expressions/plots}{GA_GS_NEC_RRDD-R_square}{\( \gls{funGa}^{\gls{nec}}(r) \)}%
\smallfig{fig:rrddr-Ga-woa}{insert/expressions/plots}{GA_GS_WOA_RRDD-R_square}{\( \gls{funGa}^{\gls{woa}}(r) \)}%
\smallfig{fig:rrddr-Ga-gbb}{insert/expressions/plots}{GA_GS_GBB_RRDD-R_square}{\( \gls{funGa}^{\gls{gbb}}(r) \)}%
...
By considering the density as being homogeneous inside the walls, it is possible to express the fluctuation term \( \delta \) used in equation \eqref{eq:guw}.
...
\subsubsection{Density fluctuation}
...
By substituting the function \( \gls{funM}^*_{\alpha \beta} \) by its expression for \gls{rrdde} and \gls{rrddr} we obtain the value of \( \delta \) in \figref{fig:rrdde-fluctuation} and \figref{fig:rrddr-fluctuation}.

\medfig{fig:rrdde-fluctuation}{insert/expressions/plots}{delta_RRDD-E}{Density fluctuation in \gls{rrdde}.}%
\medfig{fig:rrddr-fluctuation}{insert/expressions/plots}{delta_RRDD-R}{Density fluctuation in \gls{rrddr}.}%
...
\pyscript{insert/input}{input\_data.py}

\txtlst{insert/input/croped}{input\_data.txt}
